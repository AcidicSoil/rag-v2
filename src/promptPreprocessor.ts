...
// Ensure config.ts (generated by your script) exports these
  ...
  try {
    ...
    if (selectedModelId !== AUTO_DETECT_MODEL_ID) {
      ...
      if (loadedModels.length > 0) {
        ...
        // Fallback: Find a downloaded model
    ...
    ctl.debug(`Error resolving embedding model: ${errorMessage}`);
...
// must remain in the file. They are identical to previous versions.
